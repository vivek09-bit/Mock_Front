...
import { FaChartBar, FaEye, FaTrash, FaEdit, FaChevronRight } from 'react-icons/fa';
                  ...
                  <tr key={test._id} className="hover:bg-slate-50/30 transition-colors group">
                    ...
                    <td className="px-8 py-5 text-right">
                      <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Link to={`/instructor/test-stats/${test._id}`} className="p-2 text-slate-400 hover:text-slate-800 hover:bg-slate-100 rounded-lg transition-colors">
                            <FaChevronRight />
                        </Link>
                      </div>
                    </td>
