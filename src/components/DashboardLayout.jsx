    ...
    <div className="flex flex-col h-screen font-inter">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          <div className="p-6">
            <h2 className="flex items-center text-xl font-bold text-slate-800 uppercase tracking-wider">Dashboard</h2>
          </div>
          ...
          <nav className="flex-1 px-4 py-2 space-y-2 overflow-y-auto relative z-10">
            {menuItems.map((item) => (
              ...
              >
                ...
                <span className={`font-bold transition-colors ${location.pathname === item.path ? 'text-purple-900' : 'text-blue-800 group-hover:text-purple-900'}`}>
                  {item.name}
                </span>
              </Link>
            ))}
          ...
          <div className="p-4 mt-auto relative z-10">
            <button
              ...
              className="flex items-center gap-4 w-full px-4 py-3 text-black-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all"
            >
